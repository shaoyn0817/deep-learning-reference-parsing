...
public class MentionHypergraphMainBIO {
	...
	public static String nnOptimizer = "sgd";
	public static double lr = 1;
	public static OptimizerFactory optimizer =  OptimizerFactory.getGradientDescentFactoryUsingGradientClipping(BestParamCriteria.BEST_ON_DEV, lr, 5);
	//public static OptimizerFactory optimizer =  OptimizerFactory.getGradientDescentFactoryUsingAdaGrad(BestParamCriteria.BEST_ON_DEV, lr);
	...
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException{
		...
		NetworkConfig.BATCH_SIZE = 20;  
		int gap = 200;
		NetworkConfig.OPTIMIZE_NEURAL =  true;
        NetworkConfig.INIT_FV_WEIGHTS = false;
 //Iteration 0: Obj=-715.621588023468  Time=2.716s 0.000000000000 Total time: 2.716s
//Iteration 0: Obj=-712.019688740008  Time=1.865s 0.000000000000 Total time: 1.865s
        //Iteration 0: Obj=-134618.915739401040 Time=3.425s 0.000000000000 Total time: 3.425s
        //Iteration 0: Obj=-134631.542581636630 Time=3.438s 0.000000000000 Total time: 3.438s
       String modelPath = "kk.model";
		...
		if(NetworkConfig.USE_NEURAL_FEATURES){
			if (neuralType.equals("lstm")) {
				...
				nets.add(new MultiLayerPerceptron(neural_config, size));
			}
		...
		if(serializeModel){
			...
			model.train(trainInstances, numIterations, devInstances, evalFunc, gap);
