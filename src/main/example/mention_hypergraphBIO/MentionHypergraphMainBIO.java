package org.statnlp.example.mention_hypergraphBIO;
...
import org.statnlp.example.mention_hypergraphBIO.MentionHypergraphFeatureManager.FeatureType;
import org.statnlp.example.mention_hypergraphBIO.MentionHypergraphInstance.WordsAndTags;
   ...
   //public static OptimizerFactory optimizer =  OptimizerFactory.getLBFGSFactory();
	...
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException{
       ...
       String modelPath = "kk.model";
		...
		String dev = "data/data/"+dataset+"/train2.data";
